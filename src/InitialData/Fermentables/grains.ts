import { IFERMENTABLE } from '../InitialDataInterface';

export default <IFERMENTABLE[]>[
  {
    name: 'Acid Malt',
    potential: 1.027,
    yield: 0.587,
...

  {
    ...
    protein: 0.16,
    notes:
      'Raw barley that has been popped to open the kernels. Used in place of raw barley for faster conversion and higher yield:s. High in haze producing protein:',
  },
...

  {
    ...
    protein: 0.132,
    notes:
      'Dark color: and dry roasted flavor characteristic of Stouts and Porters. Used for Color:ing in small amounts, or flavoring of Stouts and Porters in larger amounts.',
  },
...

  {
    ...
    protein: 0.103,
    notes:
      'Adds a dry, crisp character to the beer. Yield:s a deep red color:, and a distinctive rye flavor',
  },
