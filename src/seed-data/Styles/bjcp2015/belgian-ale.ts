const belgianAle: TStyle[] = [
...

  {
    ...
    examples:
      "Ch'Ti (brown and blond), Jenlain (amber and blond), La Choulette (all 3 versions), St. Amand (brown), Russian River Perdition",
    notes:
