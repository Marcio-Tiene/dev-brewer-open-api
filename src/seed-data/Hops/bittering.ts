const bittering: THop[] = [
  ...
  },
  {
    ...
    hsi: 0.85,
    notes:
      'Excellent bittering profile and a nice, hoppy, floral aroma and subtle characters of citrus. Genetically indistinguishable from the German variety',
    caryophyllene: 0.1,
    alpha: 0.14,
